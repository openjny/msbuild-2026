...
Flatcar Container Linux をベースとしたイミュータブル・コンテナ最適化 OS を GA で発表。イメージベースの自動更新、SELinux Enforcing デフォルト、dm-verity によるルートファイルシステム整合性検証を備え、AKS 上の規制対応・高セキュリティ環境向けコンテナホストとして提供。構成ドリフトを排除し、プラットフォームチームの運用負荷を大幅に削減する。
...
- [https://techcommunity.microsoft.com/blog/linuxandopensourceblog/introducing-azure-container-linux-acl/4523411](https://techcommunity.microsoft.com/blog/linuxandopensourceblog/introducing-azure-container-linux-acl/4523411)
