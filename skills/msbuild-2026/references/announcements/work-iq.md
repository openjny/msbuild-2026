...
エージェントが Microsoft 365 のデータ・アプリにアクセスするための新しいインテリジェンスレイヤー Work IQ と、その API セットを発表。Work IQ APIs は 2026年6月16日に GA 予定で、Chat・Context・Tools・Workspaces の4ドメインを提供。併せて Web IQ（エージェント向けウェブグラウンディング API スイート）も発表。
