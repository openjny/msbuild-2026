...
GitHub Copilot CLI を Build 2026 で大幅刷新。ラバーダックと音声入力が GA、プロンプトスケジューリングと新ターミナル UI が experimental で提供。クラウド/ローカルサンドボックスを Public Preview で追加し、Microsoft MXC ベースのセキュア分離環境でエージェンティックワークフローを実現する。
...
- [https://github.blog/changelog/2026-06-02-copilot-cli-improved-ui-rubber-duck-prompt-scheduling-and-voice-input](https://github.blog/changelog/2026-06-02-copilot-cli-improved-ui-rubber-duck-prompt-scheduling-and-voice-input)
