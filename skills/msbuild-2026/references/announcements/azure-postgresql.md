...
Build 2026 で 14 の新機能を発表。V6 SKU（NVMe 対応、192 vCores）GA、pg_duckdb による高速分析 GA、AI アシスト Oracle→PostgreSQL 移行 GA、Defender セキュリティ評価 Preview、Chaos Studio 連携 Preview、temporal_tables GA、組み込み Grafana ダッシュボード GA、計画メンテナンスの自主制御 GA など、パフォーマンス・セキュリティ・運用・移行を包括的に強化。
...
- [https://techcommunity.microsoft.com/blog/adforpostgresql/announcing-new-security-maintenance-and-analytics-features-for-postgresql-at-mic/4524559](https://techcommunity.microsoft.com/blog/adforpostgresql/announcing-new-security-maintenance-and-analytics-features-for-postgresql-at-mic/4524559)
