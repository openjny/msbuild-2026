...
Foundry Local の Build 2026 更新として、プラットフォームサポートの拡大、ハードウェアアクセラレーション制御の改善、新しいオンデバイス API、Azure Local 統合を発表。AI PC、エッジデバイス、切断環境、主権 AI 要件に対応し、ローカルでの AI 推論とエージェント実行を簡素化する。
