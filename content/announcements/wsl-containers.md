...
summary: Linux コンテナを Windows 上でネイティブ実行する WSL containers を発表。wslc.exe CLI と API を提供し、サードパーティツールに依存せずにコンテナのビルド・実行・操作が可能に。ローカル開発、AI/ML ワークフロー、コンテナ化テストに対応。近日 Public Preview 予定。
tags:
  - wsl
  - windows-dev
...
- [WSL GitHub リポジトリ](https://github.com/microsoft/WSL)
