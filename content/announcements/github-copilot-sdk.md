...
- [Copilot SDK is now generally available — Changelog](https://github.blog/changelog/2026-06-02-copilot-sdk-is-now-generally-available)
...
- [GitHub Copilot SDK ドキュメント](https://docs.github.com/en/copilot/concepts/agents/copilot-sdk)

## 関連エントリ

- [GitHub Copilot CLI](./github-copilot-cli.md) — SDK と同じエージェントランタイムを使用する CLI。サンドボックス機能を提供
- [GitHub Copilot App](./github-copilot-app.md) — Copilot CLI 上に構築されたエージェントネイティブ・デスクトップアプリ。同一ランタイム基盤
- [Microsoft Foundry](./microsoft-foundry.md) — Agent Framework のハーネスとして Copilot SDK を統合
