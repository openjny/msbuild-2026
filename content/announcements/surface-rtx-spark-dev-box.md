...
- [Building the next generation of devices for developers: Surface RTX Spark Dev Box（Surface Devices Blog）](https://blogs.windows.com/devices/2026/06/02/building-the-next-generation-of-devices-for-developers-surface-rtx-spark-dev-box)
...
- [Surface RTX Spark Dev Box 製品ページ](https://www.microsoft.com/en-us/surface/devices/surface-rtx-spark-dev-box)
- [Surface Laptop Ultra 製品ページ](https://www.microsoft.com/en-us/surface/devices/surface-laptop-ultra)
- [NVIDIA and Microsoft Reinvent Windows PCs for the Age of Personal AI（NVIDIA プレスリリース）](https://investor.nvidia.com/news/press-release-details/2026/NVIDIA-and-Microsoft-Reinvent-Windows-PCs-for-the-Age-of-Personal-AI/default.aspx)
...
- [Windows Development](windows-dev.md) — 開発者プラットフォーム全体の Build 2026 更新
- [Foundry Local](foundry-local.md) — ローカル AI 推論プラットフォーム
- [Windows AI APIs](windows-ai-apis.md) — Aion 1.0 SLM、Windows ML
- [Windows Dev Config](windows-dev-config.md) — WinGet 設定による環境セットアップ自動化
- [WSL containers](wsl-containers.md) — WSL コンテナ実行
