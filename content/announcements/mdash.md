...
id: mdash
title: "MDASH"
summary: "Microsoft Security Multi-model Agentic Scanning Harness (MDASH) の Expanded Preview を発表。100 以上の特化 AI エージェントを 5 段階パイプラインでオーケストレーションし、コードベースの脆弱性を自動検出・検証・証明するエージェンティックセキュリティシステム。Build 2026 で Microsoft Defender 統合を追加し、CyberGym ベンチマークで 96.55% のスコアを達成。Windows カーネルの重大 RCE 脆弱性 16 件を発見した実績を持つ。"
tags:
...
- [Microsoft Defender ドキュメント](https://learn.microsoft.com/microsoft-365/security/defender/)
- [Build 2026 キーノート](https://build.microsoft.com/sessions/KEY01)

## 関連エントリ

- [GitHub Code Security](github-code-security.md)
