...
id: microsoft-iq
title: Microsoft IQ
summary: Work IQ・Fabric IQ・Foundry IQ・Web IQ を統合するインテリジェンスレイヤー Microsoft IQ を発表。Work IQ APIs は 2026年6月16日に GA 予定で Chat・Context・Tools・Workspaces の4ドメインを提供。Web IQ はモデル非依存・MCP ネイティブのウェブグラウンディング API スイートとして限定提供開始。エージェントが組織データ・ウェブ・分析基盤のコンテキストに統一的にアクセスする基盤を構成する。
tags:
  - microsoft-iq
  - m365-copilot
  - azure-ai-foundry
...
- [Work IQ: Production-ready intelligence for every agent（M365 Dev Blog）](https://devblogs.microsoft.com/microsoft365dev/work-iq-production-ready-intelligence-for-every-agent)
- [Work IQ on GitHub](https://github.com/microsoft/work-iq)
- [Work IQ overview（Microsoft Learn）](https://learn.microsoft.com/en-us/microsoft-365/copilot/extensibility/work-iq)
- [Foundry IQ: Build smarter agents faster（Foundry Blog）](https://devblogs.microsoft.com/foundry/build-smarter-agents-faster-with-foundry-iq)
- [Announcing Microsoft Web IQ（Bing Search Blog）](https://blogs.bing.com/search/June-2026/Announcing-Microsoft-Web-IQ)
- [Microsoft Web IQ 公式ページ](https://www.microsoft.com/en-us/webiq)
...
- [Microsoft Build 2026 Live Blog](https://news.microsoft.com/build-2026-live-blog/microsoft-build-2026-live)

## 関連エントリ

- [Foundry IQ](foundry-iq.md) — 統合ナレッジレイヤーとしての Foundry IQ 詳細
- [Microsoft Foundry](microsoft-foundry.md) — Foundry エージェントプラットフォーム全体
- [Microsoft Fabric](microsoft-fabric.md) — Fabric IQ の基盤である Microsoft Fabric
- [Microsoft Scout](microsoft-scout.md) — Work IQ をコンテキストエンジンとする Autopilot エージェント
- [M365 Copilot](m365-copilot.md) — Work IQ が支える M365 Copilot 体験
