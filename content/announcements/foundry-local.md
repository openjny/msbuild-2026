...
id: foundry-local
title: Foundry Local
summary: Foundry Local v1.2.0 を発表。多言語リアルタイム音声文字起こし（40 言語以上）、Linux ARM64 対応、Windows ML 2.0 による NPU/GPU アクセラレーション強化、推論キャンセル、クロスリージョンモデルカタログを追加。さらに Foundry Local on Azure Local（Preview）でオンプレミス・切断環境でのマルチノード推論と Agentic RAG を提供する。
tags:
  - foundry-local
  - azure-ai-foundry
...
official_sources:
  ...
  - https://techcommunity.microsoft.com/blog/azurearcblog/build-deploy-and-govern-sovereign-ai-with-foundry-local-on-azure-local/4522945
  - https://techcommunity.microsoft.com/blog/azurearcblog/scale-on-prem-ai-with-foundry-local-on-azure-local-multi-node-inference-and-vllm/4516692
deliveries:
  site: true
  llms: true
  skills: true
...
- [Build, deploy, and govern sovereign AI with Foundry Local on Azure Local](https://techcommunity.microsoft.com/blog/azurearcblog/build-deploy-and-govern-sovereign-ai-with-foundry-local-on-azure-local/4522945)
- [Scale On-Prem AI with Foundry Local on Azure Local: Multi-Node Inference and vLLM Support](https://techcommunity.microsoft.com/blog/azurearcblog/scale-on-prem-ai-with-foundry-local-on-azure-local-multi-node-inference-and-vllm/4516692)
- [Foundry Local ドキュメント](https://learn.microsoft.com/azure/foundry-local/)
- [Foundry Local GitHub リポジトリ](https://github.com/microsoft/foundry-local)
- [Build Apps with Local AI for Unmetered Intelligence on every Windows PC (BRK260)](https://build.microsoft.com/sessions/BRK260)

## 関連エントリ

- [Microsoft Foundry](microsoft-foundry.md) — クラウド AI プラットフォーム全体像
- [Surface RTX Spark & Dev Box](surface-rtx-spark-dev-box.md) — ローカル AI 開発ハードウェア
- [MAI Models](mai-models.md) — Foundry Local で利用可能なオンデバイスモデル
